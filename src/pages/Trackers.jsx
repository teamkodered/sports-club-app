      ...
      {tab === 'attendance' && (
        <div>
          <p style={{ fontSize: 13, color: 'var(--text-secondary)', marginBottom: 14 }}>
            Attendance log from check-ins. {attendance.length} total records.
          </p>
          <div className="card" style={{ padding: 0, overflowX: 'auto' }}>
            <table>
              <thead>
              ...
              <tbody>
                {(() => {
                  ...
                  attendance.forEach(a => {
                    ...
                    if (!byStudent[a.student_id].last || a.attended_at > byStudent[a.student_id].last)
                      byStudent[a.student_id].last = a.attended_at
                  })
                    ...
                    .map(s => {
                      ...
                      return (
                        <tr key={s.id}>
                          ...
                          <td style={{ textAlign: 'center', fontWeight: 700, fontSize: 15, color: '#1d9e75' }}>{att.total}</td>
